...
class KeyPair:
	...
	@classmethod
	def from_file(klass,filename,password=None):
		raw=file(filename,"rb").read()
		if password:
			p12=OpenSSL.crypto.load_pkcs12(raw,password)
		else:
			p12=OpenSSL.crypto.load_pkcs12(raw)
		return klass(p12.get_privatekey(),p12.get_certificate())
